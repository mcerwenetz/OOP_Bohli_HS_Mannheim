...
public:
    ...
    int add_text(int x=0, int y=0, const char *text="X",
                 int px=24, /* font size in pixel, not pt*/
                 sf::Color color=sf::Color::White);
...
/** Anzeige von Pixelgraphiken und Animationen in einer 
 * Zeichenfläche mit beliebiger Dimension Breite <= 600.
 ...
 * Es sollten als Breiten idealerweise nur 600, 300, 150, 100
 * oder kleiner genommen werden. Links oben ist (0, 0).
 */
